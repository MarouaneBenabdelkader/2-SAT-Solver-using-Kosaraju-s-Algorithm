...
//        ? test of parser current state
        try {
            String filename = "formulas/formule-2-sat.txt"; // Default testing file

            // pick another file to test by passinf arguments to the Main
            if (0 < args.length) {
                filename = "../formulas/testSet" + args[0] + "/formula" + args[1] + ".txt";
            }
